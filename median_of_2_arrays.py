...
# Space Complexity O(1), constant extra space
    def findMedianSortedArrays(self, nums1, nums2):
        ...
        :rtype: float
        """
         # WE SHALL DO BINARY SEARCH ON THE SMALLER ARRAY, NUMS1>space saved
        ...
        while lo <= hi:
            ...
            p1 = (lo + hi) // 2  #set 1st partition as mid of nums1
            p2 = left_partition_size - p1  #set 2nd partition as main arary half-p1
            ...
            # MOVE P1 LEFTWARDS
            #i can only move p1 so if window from left is more , shrink it
